        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              I'm always open to discussing data field opportunities,
              collaborations, or just having a chat about digital solutions.
            </p>
          </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="mailto:m.v.rosset@outlook.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    m.v.rosset@outlook.com
                  </a>
              ...
              <div className="space-y-4 pt-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://www.linkedin.com/in/mvrosset24680/"
                    target="_blank"
          ...
          >
            <p>
              © {new Date().getFullYear()} Marcos Rosset
            </p>
            <p className="mt-2">Data Analyst • Python, BI, Code development</p>
          </motion.div>
        </motion.div>
      </div>
    </footer>
