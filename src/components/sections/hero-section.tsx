      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div>
            ...
            >
              I am currently searching for new oportunities as a Mid Data Analyst. I
              have over 3 years of experience working with teams developing BI solutions 
              in many different enterprises, with experience with such tools like PowerBI,
              SQL, Python for APIs integrations and machine learning process.
            </motion.p>
          </div>
